...
@interface SSPresentationController()
...
@implementation SSPresentationController
...
- (void)presentationTransitionWillBegin {
    ...
    //self.containerView就是Transition里面的上下文，可以直接取
    ...
    //presentedView就是Transition里面的toView
    ...
    // 这里很诡异，但是Presentation动画就是伴随着Transition出现的，所以名字叫animateAlongsideTransition也说得通
